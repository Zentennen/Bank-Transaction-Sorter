...
type
  ...
  public
     ...
     procedure addText(const text: PWideChar; font: TFont); overload;
...
function TRichString.addFont(initFont: TFont): TFont;
var
  fntHandle: FontHandle;
begin
...
function TSheet.firstFilledRow: Integer;
begin
  result := xlSheetFirstFilledRow(handle);
end;

function TSheet.lastFilledRow: Integer;
begin
  result := xlSheetLastFilledRow(handle);
end;

function TSheet.firstFilledCol: Integer;
begin
  result := xlSheetFirstFilledCol(handle);
end;

function TSheet.lastFilledCol: Integer;
begin
